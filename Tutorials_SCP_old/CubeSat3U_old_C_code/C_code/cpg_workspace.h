...
// Parameter deltas
typedef struct {
  cpg_float    *lamb;      // Delta of your parameter lamb
  cpg_float    *start_pos;   // Delta of your parameter start_pos
  cpg_float    *end_pos;   // Delta of your parameter end_pos
  cpg_float    *A_discrete_qw;   // Delta of your parameter A_discrete_qw
  cpg_float    *B_discrete_qw_scaled;   // Delta of your parameter B_discrete_qw_scaled
  cpg_float    *w_discrete_qw;   // Delta of your parameter w_discrete_qw
...
extern cpg_float cpg_params_vec[2635];
...
// Canonical parameters
extern cpg_float canon_c[878];
extern cpg_float canon_c_conditioning[878];
...
extern cpg_float canon_h[1505];
extern cpg_float canon_h_conditioning[1505];
...
extern cpg_float cpg_u[90];
extern cpg_float cpg_vc[210];
extern cpg_float cpg_nx[217];

...
extern void cpg_update_lamb(cpg_float val);
extern void cpg_update_start_pos(cpg_int idx, cpg_float val);
extern void cpg_update_end_pos(cpg_int idx, cpg_float val);
extern void cpg_update_A_discrete_qw(cpg_int idx, cpg_float val);
extern void cpg_update_B_discrete_qw_scaled(cpg_int idx, cpg_float val);
extern void cpg_update_w_discrete_qw(cpg_int idx, cpg_float val);

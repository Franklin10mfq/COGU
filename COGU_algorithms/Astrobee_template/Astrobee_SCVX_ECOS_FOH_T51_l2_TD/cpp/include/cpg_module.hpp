...
struct CPG_Params_cpp_t {
    ...
    std::array<double, 3900> B_discrete_l;
    std::array<double, 3900> B_discrete_r;
    std::array<double, 650> F_discrete;
    std::array<double, 650> y_discrete;
    std::array<double, 1989> C_discrete;
    std::array<double, 918> D_discrete;
    std::array<double, 153> G_discrete;
    std::array<double, 153> z_discrete;
    std::array<double, 663> ox_cvxpy;
    std::array<double, 306> ou_cvxpy;
    double op_cvxpy;
    double etta;

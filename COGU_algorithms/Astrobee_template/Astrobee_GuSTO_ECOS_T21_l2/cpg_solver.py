...
from Astrobee_GuSTO_ECOS_T21_l2 import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    prob.var_dict['u'].save_value(np.array(res.cpg_prim.u).reshape((6, 21), order='F'))
    prob.var_dict['x'].save_value(np.array(res.cpg_prim.x).reshape((13, 21), order='F'))

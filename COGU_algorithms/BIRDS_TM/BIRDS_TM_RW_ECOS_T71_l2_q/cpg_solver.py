...
from BIRDS_TM_RW_ECOS_T71_l2_q import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["sqrt_tau", "sqrt_tau_xq_goal", "tau_lamb", "start_pos", "end_pos", "A_discrete", "B_discrete", "y_discrete", "ox_cvxpy", "ou_cvxpy", "etta", "inv_Jb_S_b_scaling", "inv_Jb_c_b_scaling", "omegab_max", "inv_JW_S_W_scaling", "inv_JW_c_W_scaling", "speedW_max", "S_u_scaling", "c_u_scaling", "torqW_max"]
    ...
    prob.var_dict['u'].save_value(np.array(res.cpg_prim.u).reshape((3, 70), order='F'))
    prob.var_dict['x'].save_value(np.array(res.cpg_prim.x).reshape((10, 71), order='F'))
    prob.var_dict['vc'].save_value(np.array(res.cpg_prim.vc).reshape((10, 70), order='F'))
    ...
    prob.constraints[52].save_dual_value(np.array(res.cpg_dual.d52).reshape((10, 1), order='F'))
    prob.constraints[53].save_dual_value(np.array(res.cpg_dual.d53).reshape((10, 1), order='F'))
    prob.constraints[54].save_dual_value(np.array(res.cpg_dual.d54).reshape((10, 1), order='F'))
    prob.constraints[55].save_dual_value(np.array(res.cpg_dual.d55).reshape((10, 1), order='F'))
    prob.constraints[56].save_dual_value(np.array(res.cpg_dual.d56).reshape((10, 1), order='F'))
    prob.constraints[57].save_dual_value(np.array(res.cpg_dual.d57).reshape((10, 1), order='F'))
    prob.constraints[58].save_dual_value(np.array(res.cpg_dual.d58).reshape((10, 1), order='F'))
    prob.constraints[59].save_dual_value(np.array(res.cpg_dual.d59).reshape((10, 1), order='F'))
    prob.constraints[60].save_dual_value(np.array(res.cpg_dual.d60).reshape((10, 1), order='F'))
    prob.constraints[61].save_dual_value(np.array(res.cpg_dual.d61).reshape((10, 1), order='F'))
    prob.constraints[62].save_dual_value(np.array(res.cpg_dual.d62).reshape((10, 1), order='F'))
    prob.constraints[63].save_dual_value(np.array(res.cpg_dual.d63).reshape((10, 1), order='F'))
    prob.constraints[64].save_dual_value(np.array(res.cpg_dual.d64).reshape((10, 1), order='F'))
    prob.constraints[65].save_dual_value(np.array(res.cpg_dual.d65).reshape((10, 1), order='F'))
    prob.constraints[66].save_dual_value(np.array(res.cpg_dual.d66).reshape((10, 1), order='F'))
    prob.constraints[67].save_dual_value(np.array(res.cpg_dual.d67).reshape((10, 1), order='F'))
    prob.constraints[68].save_dual_value(np.array(res.cpg_dual.d68).reshape((10, 1), order='F'))
    prob.constraints[69].save_dual_value(np.array(res.cpg_dual.d69).reshape((10, 1), order='F'))
    prob.constraints[70].save_dual_value(np.array(res.cpg_dual.d70).reshape((10, 1), order='F'))
    prob.constraints[71].save_dual_value(np.array(res.cpg_dual.d71).reshape((10, 1), order='F'))

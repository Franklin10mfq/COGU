...
from WaskiriSat_SCVX_ECOS_T51 import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["sqrt_tau", "tau_lamb", "start_pos", "end_pos", "A_discrete", "B_discrete", "y_discrete", "ox_cvxpy", "ou_cvxpy", "etta", "S_x_scaling", "c_x_scaling", "omega_max", "S_u_scaling", "c_u_scaling", "m_max"]
